    ...
    <div className="mt-12">
      <form>
        ...
        <div className="mt-8">
          ...
          <input name="matKhau" onChange={Formik.handleChange} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type placeholder="Nhập vào mật khẩu password" />
        </div>
        <div className="mt-10">
